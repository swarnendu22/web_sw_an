...
@Component({
  selector: 'app-pending-merchants',
  templateUrl: './pending-merchants.component.html',
  styleUrls: ['./pending-merchants.component.css'],
...
export class PendingMerchantsComponent implements OnInit {
  ...
  ngOnInit() {
    console.log('Test Timing 2');
    this.payLoadForSearch.status = 'PENDING'
  ...
  onFirstDataRendered(params) {
    ...
    this.gridColumnApi.setColumnVisible('business_category_name', false);
  }
