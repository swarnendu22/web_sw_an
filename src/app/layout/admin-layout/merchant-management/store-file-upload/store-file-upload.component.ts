...
import { GetStoreSpecificBulkList } from 'src/app/actions/merchant-management.actions';
import { UploadContentSheet } from 'src/app/actions/seller-catalog-action';
...
import { AdminFileUploadComponent } from '../../catalog-management/admin-file-upload/admin-file-upload.component';

@Component({
  selector: 'app-store-file-upload',
  templateUrl: './store-file-upload.component.html',
  styleUrls: ['./store-file-upload.component.css']
})
export class StoreFileUploadComponent implements OnInit {
  ...
  attributeSetId = null
  constructor(private store: Store<categoryState>, public dialog: MatDialog,
