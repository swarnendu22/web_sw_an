...
@Component({
  selector: 'app-delivery-boy-debit-note',
  templateUrl: './delivery-boy-debit-note.component.html',
  styleUrls: ['./delivery-boy-debit-note.component.css']
})
export class DeliveryBoyDebitNoteComponent implements OnInit {
