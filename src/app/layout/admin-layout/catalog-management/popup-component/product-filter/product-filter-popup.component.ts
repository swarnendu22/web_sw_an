...
import { GetCategory } from 'src/app/actions/storeManagement.action';
import { GetActiveBrands } from 'src/app/actions/brand-management.actions';
...
@Component({
  ...
  templateUrl: './product-filter-popup.component.html',
  styleUrls: ['./product-filter-popup.component.css']
})
export class ProductFilterPopupComponent {
  ...
  onSubmit() {
    ...
    // }
    this.store.dispatch(new GetAllCatalogList({ pageNo: 1, body: this.data }));
