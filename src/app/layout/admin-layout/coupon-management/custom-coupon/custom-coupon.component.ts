...
@Component({
  ...
  styleUrls: ['./custom-coupon.component.css']
})
export class CustomCouponComponent implements OnInit {
  couponCodeVal = null;
  pageNo = 1;
  perPage = 20;
  totalRecords = 0;
  displayedColumns =
      ['code', 'description', 'start_date', 'end_date', 'coupon_type', 'restriction_per_user', 'coupon_effect_seller_nsp', 'active', 'expired'];
