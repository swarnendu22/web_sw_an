...
@Component({
  selector: 'app-delivery-boy-merchandise',
  templateUrl: './delivery-boy-merchandise.component.html',
  styleUrls: ['./delivery-boy-merchandise.component.css']
})
export class DeliveryBoyMerchandiseComponent implements OnInit {
  private gridApi;
