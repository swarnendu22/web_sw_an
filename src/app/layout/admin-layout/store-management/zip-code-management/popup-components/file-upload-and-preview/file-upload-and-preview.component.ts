...
@Component({
  selector: 'app-file-upload-and-preview',
  templateUrl: './file-upload-and-preview.component.html',
  styleUrls: ['./file-upload-and-preview.component.css'],
  animations: [
...
export class FileUploadAndPreviewComponent implements OnInit, OnDestroy {
  ...
  constructor(public fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<FileUploadAndPreviewComponent>
  ) {
  ...
  readExcel() {
    ...
    reader.onload = (e) => {
      ...
      console.log('Final Excel', JSON.parse(finalPayload));
      if (this.dataValidation(this.worksheet)) {
        ...
        // });
        // this.finalData.forEach((curr, i) => {
        //   const curZipcode = curr.zipCode.toString()
        //   let prevZipCode = ''
        //   if (curZipcode == prevZipCode) {
        //     this.finalData['isDuplicate'] = true
        //   } else if (curZipcode != prevZipCode) {
        //     prevZipCode = curZipcode
        //   }
        // })
        // console.log('Find', this.finalData)
        // this.isFileUploaded = true
        // this.dialogRef.updateSize('750px', '1440px');
