...
@Component({
  selector: 'app-rejected-merchants',
  templateUrl: './rejected-merchants.component.html',
  styleUrls: ['./rejected-merchants.component.css'],
  providers: [NgbModalConfig, NgbModal],
})
export class RejectedMerchantsComponent implements OnInit {
  ...
  ngOnInit() {
    this.payLoadForSearch.status = 'DELETED'
