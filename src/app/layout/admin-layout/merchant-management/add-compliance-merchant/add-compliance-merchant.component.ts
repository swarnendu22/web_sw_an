...
@Component({
  selector: 'app-add-compliance-merchant',
  templateUrl: './add-compliance-merchant.component.html',
  styleUrls: ['./add-compliance-merchant.component.css']
})
export class AddComplianceMerchantComponent implements OnInit {
