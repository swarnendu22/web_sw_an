...
@Component({
  selector: 'app-delivery-boy-cancel-pickup-reasons',
  templateUrl: './delivery-boy-cancel-pickup-reasons.component.html',
  styleUrls: ['./delivery-boy-cancel-pickup-reasons.component.css']
})
export class DeliveryBoyCancelPickupReasonsComponent implements OnInit {
  private gridApi;
  ...
  constructor(private ag: AgGridOptions,
    ...
    this.columnDefs = [
      ...
      },
      {
        ...
        field: 'value',
        colId: 'params',
        cellRendererFramework: CellRendererDeliveryBoyCancelPickupReasonsComponent,
        // cellRendererParams: {
  ...
  onGridReady(event) {
    ...
    this.store
      ...
      .subscribe(res => {
        if (res.cancelPickupReasons) {
          console.log(res.cancelPickupReasons)

          this.rowData = res.cancelPickupReasons;
